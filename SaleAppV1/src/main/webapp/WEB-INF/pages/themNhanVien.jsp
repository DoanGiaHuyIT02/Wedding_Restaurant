...
<form:form modelAttribute="themNhanVien" action="${action}" method="post">
    ...
    <h2>Tài khoản</h2>
    <div class="form-floating mb-3 mt-3">
        <form:input type="text" class="form-control" path="taiKhoanId.tenDangNhap" id="taiKhoan" placeholder="Tên đăng nhập" name="taiKhoan" />
        <label for="taiKhoan">Tên đăng nhập</label>
    </div>
    <div class="form-floating mb-3 mt-3">
        <form:input type="text" class="form-control" path="taiKhoanId.matKhau" id="matKhau" placeholder="Mật khẩu" name="matKhau" />
